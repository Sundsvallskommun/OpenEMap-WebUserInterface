        ...
        buttons: [
            {
                ...
                id     : 'submit_box',
                handler: function() {
                    Ext.MessageBox.confirm('Confirm', 'Did you fill out all fields correctly?');
                }
            }
        ]
...
function getGrid () {
    ...
    return {
        ...
        columns: [
            ...
            {header: "Change",       width: 85,  sortable: true, dataIndex: 'change'},
            {header: "% Change",     width: 105,  sortable: true, dataIndex: 'pctChange'},
            {header: "Last Updated", width: 150,  sortable: true, xtype: 'datecolumn', dataIndex: 'lastChange', format: 'Y-m-d'}
        ],
        loadMask: true,
...
function getScrollingTabs () {
    return getTabs({
        ...
        items: [
            {
                title: 'Tab 1',
                html : '<p class="lead">Tab panel 1 content</p>'
            },
            {
                title: 'Tab 2',
...
function getToolsToolbar() {
    return {
        ...
        rtl: rtl,
        items: [{
            toggleGroup: 'oep-toolset',
            allowDepress: false,
            icon: 'http://extjs.dev.osynlig.se/osynlig-oep-workspace/build/ThemeDemoApp/production/resources/images/icons/toolbar-demo-line.png',
            pressed: true
        }, {
            toggleGroup: 'oep-toolset',
            allowDepress: false,
            icon: 'http://extjs.dev.osynlig.se/osynlig-oep-workspace/build/ThemeDemoApp/production/resources/images/icons/toolbar-demo-point.png'
        }, {
            toggleGroup: 'oep-toolset',
            allowDepress: false,
            icon: 'http://extjs.dev.osynlig.se/osynlig-oep-workspace/build/ThemeDemoApp/production/resources/images/icons/toolbar-demo-polygon.png'
        }, {
            toggleGroup: 'oep-toolset',
            allowDepress: false,
            tooltip: 'Rita Z',
            cls: 'oep-tools-last',
            icon: 'http://extjs.dev.osynlig.se/osynlig-oep-workspace/build/ThemeDemoApp/production/resources/images/icons/toolbar-demo-area.png'
        }]
    }
}
...
function getProgressBar () {
    ...
    progressbar.on("update", function() {
        var progress = "";
        var id = progressbar.id + "-bar";
        if(progressbar.done) {
            progress = "";
            document.getElementById(id).setAttribute("style", "width: 100%; background-color: #29bf4c");
        } else {
            progress = Math.round(progressbar.value*100) + " % klar";
        }
        document.getElementById(id).setAttribute("data-progress", progress);
    }, this);
    ...
    if (!hasOption('nopbar')) {
        ...
        var o_interval = 50;
        var o_duration = 5000;
        var o_increment = (o_duration/o_interval);

        setTimeout(function() {
            progressbar.wait({
                //animate: true,
                interval: parseInt(o_interval), //bar will move fast!
                duration: parseInt(o_duration),
                increment: parseInt(o_increment),
                text: 'Updating...',
                scope: this,
                fn: function(){
    ...
    return {
        ...
        items: [
            ...
            },
            {
                ...
                scale: 'large',
                cls: 'x-action-btn',
                icon: 'http://extjs.dev.osynlig.se/osynlig-oep-workspace/build/ThemeDemoApp/production/resources/images/icons/plus.png'
            },
            {
                xtype: 'button',
                scale: 'large',
                cls: 'x-action-btn',
                icon: 'http://extjs.dev.osynlig.se/osynlig-oep-workspace/build/ThemeDemoApp/production/resources/images/icons/minus.png',
                margin: '0 0 0 5'
            },
            {
                xtype: 'button',
...
function addResizer(containerEl) {
    var rszEl = containerEl.createChild({
        style: 'background: transparent;position:absolute;left:251px;top:1320px;width:400px;height:200px;overflow:hidden',
