@echo off 
set release_name=OpenEMap-1.0.4.17
...
sencha.exe compile --classpath=..\src\main\javascript,\libs\ext-4.2.1\src,\libs\geoext-2.0.1\src exclude -all and include -namespace OpenEMap and include -file ..\src\main\javascript\OpenEMap.js and concat ..\%release_name%-debug-all.js
copy ..\*.html ..\release\%release_name%
copy ..\*.js ..\release\%release_name%
